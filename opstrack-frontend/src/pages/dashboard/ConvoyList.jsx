    ...
    return (
        <div style={{ padding: '2rem', color: '#d1fae5', background: '#11251e', minHeight: '100vh' }}>
            ...
            {loading ? (
                ...
                {/* Leaflet Map for Convoy Locations */}
                <div style={{ marginTop: '2rem', width: '100%', maxWidth: '900px', marginLeft: 'auto', marginRight: 'auto' }}>
                  <h2 style={{ color: '#22c55e', marginBottom: '1rem' }}>Convoy Locations Map</h2>
                  <MapContainer center={[34.083656, 74.797371]} zoom={8} style={{ height: '400px', width: '100%' }}>
                    <TileLayer
                    ...
                    {convoys.map(convoy => (
                      <>
                        ...
                        {/* Polyline from start to end ONLY for selected convoy */}
                        {selectedConvoy && selectedConvoy._id === convoy._id && convoy.route && convoy.route[0] && convoy.route[1] &&
                          !isNaN(convoy.route[0].latitude) && !isNaN(convoy.route[0].longitude) &&
                          !isNaN(convoy.route[1].latitude) && !isNaN(convoy.route[1].longitude) && (
                          <Polyline
